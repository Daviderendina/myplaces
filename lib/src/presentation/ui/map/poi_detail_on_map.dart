...
import 'package:myplaces/src/presentation/ui/poi/add_list_custom.dart';
import 'package:myplaces/src/presentation/ui/poi/add_list_default.dart';
...
class PoiDetailOnMapState extends ConsumerState<PoiDetailOnMap> {
  ...
  Widget build(BuildContext context) {
    List<MyList> allDefinedLists = ref.read(listServiceProvider).getAll();
    Poi poi = widget.poi;
