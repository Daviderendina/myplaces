...
class CircledEmoji extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color = isDisabled ? Theme.of(context).disabledColor : collection.emoji.color;
    ...
    return CircledView(
      ...
      border: addBorder ? Border.all(color: color.withValues(alpha: .40), width: 1.0) : null,
      child: Opacity(
